...
#define kTimeToDetermineBPMFinalResultInSeconds 2000
...
- (void)viewDidLoad
{
    ...
    NSLog(@"min %lld max %lld", [_videoDevice activeVideoMinFrameDuration], [_videoDevice activeVideoMaxFrameDuration].value);
    NSLog(@"timescale %d", [_videoDevice activeVideoMinFrameDuration].timescale);
